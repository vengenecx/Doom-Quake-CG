...
//    models.push_back(std::make_unique<PlaneModel>(roofVerticesEleven, woodFLoorTexture.get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
    ...
    models.push_back(std::make_unique<PlaneModel>(groundVerticesTen, textures[ETexture::WOODFLOOR].get(), glm::vec3(3.5f, -1.0f, -1.0f), DEFAULT));
    models.push_back(std::make_unique<PlaneModel>(groundVerticesEleven, textures[ETexture::WOODFLOOR].get(), glm::vec3(1.5f, -1.0f, -1.0f), DEFAULT));



//    models.push_back(std::make_unique<PlaneModel>(wallVerticesOneOne, textures[ETexture::CONTAINER].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesOneTwo, textures[ETexture::CONTAINER].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesTwoOne, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesTwoTwo, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesThree, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesFour, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesFive, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesSix, textures[ETexture::DOORWALL].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesSeven, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesEight, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesNine, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesTen, textures[ETexture::DOORWALL].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesEleven, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesTwelve, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesThirteen, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesFourteen, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesFifteenOne, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesFifteenTwo, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesSixsteen, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesSeventeen, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesEighteen, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesNineteenOne, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesNineteenTwo, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesTwenty, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesTwentyone, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesTwentytwo, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesTwentythree, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesTwentyfour, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesTwentyfive, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesTwentysix, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesTwentyseven, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//    models.push_back(std::make_unique<PlaneModel>(wallVerticesTwentyeight, textures[ETexture::CONCRETE].get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
//
//
//
