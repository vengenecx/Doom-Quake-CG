...
SceneOne::SceneOne(){
    ...
    models.push_back(std::make_unique<PlaneModel>(glm::vec3(1,0,6), false, true, textures[ETexture::WALL].get(),textures[ETexture::WALL_NORMAL].get(), glm::vec3(2.5f, -1.0f, -3.0f), LIGHT, lightSpaceShip,false));
    models.push_back(std::make_unique<PlaneModel>(glm::vec3(1,0,4), false, true, textures[ETexture::WALL].get(),textures[ETexture::WALL_NORMAL].get(), glm::vec3(3.5f, -1.0f, -4.0f), LIGHT, lightSpaceShip,false));
    models.push_back(std::make_unique<PlaneModel>(glm::vec3(1,0,4), false, true, textures[ETexture::WALL].get(),textures[ETexture::WALL_NORMAL].get(), glm::vec3(1.5f, -1.0f, -4.0f), LIGHT, lightSpaceShip,false));
