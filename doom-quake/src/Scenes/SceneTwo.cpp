...
SceneTwo::SceneTwo(){
    ...
    models.push_back(std::make_unique<Model>("model-files/doomSword/Doom Eternal Weapon.obj", glm::vec3(2.0f, 0.5f, 5.0f), glm::vec3(1.0f, 1.0f, 1.0f), MODEL_LOADER_SHADER));
