...
SceneTwo::SceneTwo(){
    ...
    models.push_back(std::make_unique<Model>("model-files/doomSword/Doom Eternal Weapon.obj", glm::vec3(0.6f, 0.0f, 10.0f), glm::vec3(2.0f, 2.0f, 2.0f), MODEL_LOADER_SHADER));
    models.push_back(std::make_unique<Model>("model-files/doomSword/Doom Eternal Weapon.obj", glm::vec3(4.2f, 0.0f, 10.0f), glm::vec3(2.0f, 2.0f, 2.0f), MODEL_LOADER_SHADER));
    ...
    models.push_back(std::make_unique<PlaneModel>(wallVerticesOne, containerTexture.get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
    ...
    models.push_back(std::make_unique<PlaneModel>(roofVerticesThree, concreteTexture.get(), glm::vec3(0.0f, 0.0f, 0.0f), DEFAULT));
