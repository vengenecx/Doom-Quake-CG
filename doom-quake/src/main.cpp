...
//    // ------------------------------------
//    Shader lightingShader("shader-files/multiple_lights.vs", "shader-files/multiple_lights.fs");
//    Shader lightCubeShader("shader-files/line.vs", "shader-files/line.fs");
//
...
//    unsigned int specularMap = loadTexture("model-files/cube/container.jpg");
//
